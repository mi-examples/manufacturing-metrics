# Manufacturing Metrics Portal Page
## Introduction
Some text
...
1. Your Logo
2. Your Dashboard Title
3. Filter for dates
4. The columns with the elements
5. Content (text or elements)
...
<br>
The Manufacturing Metrics Portal Page is displayed. 
